      ...
      <div className={styles.outer}>
        <div>
          ...
          <div className={styles.repobtn}>
            ...
            <p onClick={() => handleclick("https://mellow-froyo-f88246.netlify.app/")}>Visit Deploy link</p>
          </div>
        </div>
        <div>
          <h1>MamaEarth</h1>
          ...
          <div className={styles.repobtn}>
            ...
            <p onClick={() => handleclick("https://calm-sawine-27b8ed.netlify.app/")}>
              Visit Deploy link
            </p>
          </div>
        </div>
        <div>
          ...
          >
            An American travel booking website
          </p>
          <div className={styles.tech1}>
            <h3>Tech Stack:</h3>
            <div className={styles.tech}>
          ...
          <div className={styles.repobtn}>
            ...
            <p onClick={() => handleclick("https://epic-babbage-48d7bc.netlify.app/index.html")}>
              Visit Deploy link
            </p>
          </div>
        </div>
